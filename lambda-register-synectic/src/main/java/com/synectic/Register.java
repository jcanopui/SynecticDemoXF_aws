...
import com.synectic.entities.RegisterEntity;
import com.synectic.entities.RequestClass;
import com.synectic.entities.ResponseClass;

public class Register {
	
	static AmazonSNS client = new AmazonSNSClient();
	static String topicArn = "arn:aws:sns:us-east-1:688943189407:SynecticTopic";
	...
	private static String getPlatformArn(String platformType) {
		...
		platformArn = "arn:aws:sns:us-east-1:688943189407:app/GCM/DEMOXF";
		//TODO activate this code when Platform had been created
